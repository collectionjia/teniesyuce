...
const BUNDLE_KEY = 'tennis:bundle:live';
const META_KEY = 'tennis:bundle:live:fetched_at';
...
async function getBundle() {
  ...
  try {
    ...
    console.error('[tennis/live-cache] read failed:', err.message);
    return null;
  }
}
...
async function setCachedBundle(bundle, fetchedAt) {
  ...
  try {
    ...
    console.error('[tennis/live-cache] write failed:', err.message);
    return false;
  }
}
