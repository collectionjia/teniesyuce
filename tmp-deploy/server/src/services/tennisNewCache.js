...
const BUNDLE_KEY = 'tennis:bundle:new';
const META_KEY = 'tennis:bundle:new:fetched_at';
...
async function getBundle() {
  ...
  try {
    ...
    console.error('[tennis/new-cache] read failed:', err.message);
    return null;
  }
}
...
async function setCachedBundle(bundle, fetchedAt) {
  ...
  try {
    ...
    console.error('[tennis/new-cache] write failed:', err.message);
    return false;
  }
}
