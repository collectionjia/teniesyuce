...
const BUNDLE_KEY = 'tennis:bundle:inplay';
const META_KEY = 'tennis:bundle:inplay:fetched_at';
...
async function getBundle() {
  ...
  try {
    ...
    console.error('[tennis/inplay-cache] read failed:', err.message);
    return null;
  }
}
...
async function setCachedBundle(bundle, fetchedAt) {
  ...
  try {
    ...
    console.error('[tennis/inplay-cache] write failed:', err.message);
    return false;
  }
}
