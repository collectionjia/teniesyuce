...
const BUNDLE_KEY = 'tennis:bundle:range';
const META_KEY = 'tennis:bundle:range:fetched_at';
...
async function getBundle() {
  ...
  try {
    ...
    console.error('[tennis/range-cache] read failed:', err.message);
    return null;
  }
}
...
async function setCachedBundle(bundle, fetchedAt) {
  ...
  try {
    ...
    console.error('[tennis/range-cache] write failed:', err.message);
    return false;
  }
}
