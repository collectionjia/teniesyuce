...
const BUNDLE_KEY = 'tennis:bundle:settled';
const META_KEY = 'tennis:bundle:settled:fetched_at';
...
async function getBundle() {
  ...
  try {
    ...
    console.error('[tennis/settled-cache] read failed:', err.message);
    return null;
  }
}
...
async function setCachedBundle(bundle, fetchedAt) {
  ...
  try {
    ...
    console.error('[tennis/settled-cache] write failed:', err.message);
    return false;
  }
}
