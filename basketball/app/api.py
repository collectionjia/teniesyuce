...
TAG_SLUG = os.environ.get("POLY_TAG_SLUG", "nba")
SERIES_ID = os.environ.get("POLY_SERIES_ID", "10345")
...
SPORT_LABEL = os.environ.get("SPORT_LABEL", "NBA")
...
_state: dict = {"updatedAt": None, "tag": TAG_SLUG, "seriesId": SERIES_ID, "events": [], "error": None}


async def refresh() -> dict:
    events = await polymarket.fetch_nba_games()
    payload = {
